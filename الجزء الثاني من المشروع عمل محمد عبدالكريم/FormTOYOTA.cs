...
namespace CarRentai
{
    public partial class FormTOYOTA : Form
    {
        private FormTypes _typesForm;

        public FormTOYOTA(FormTypes typesForm)
        {
            InitializeComponent();
        ...
        private void FormTOYOTA_Load(object sender, EventArgs e)
        {
        }
        ...
        private void btnBRADO_Click(object sender, EventArgs e)
        {
            AddBooking("PRADO");
        }

        private void btnCAMRY_Click(object sender, EventArgs e)
        {
            AddBooking("CAMRY");
        }
    }
